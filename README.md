...
137+ tests covering: anomaly metrics, attacks, strategies, plugin discovery, training tiers, parallel execution, configuration validation, FedProx, and the scripting API.

---

## Citation

If you use FEDSIM in your research, please cite:

```bibtex
@inproceedings{korobeinikov2026intellifl,
  title={IntelliFL: A Domain-Agnostic Framework for Systematizing the Design of Dependable Federated Learning Systems},
  author={Korobeinikov, Dmitrii and Chuprov, Sergei and Barea, Arnaldo and Zatsarenko, Raman and Reznik, Leon},
  booktitle={IEEE DSN},
  year={2026}
}
```
